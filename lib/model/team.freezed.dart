...
mixin _$Team {
 ...
 TeamId get id; String get name; Color get color;
...
@useResult
$Res call({
 TeamId id, String name, Color color
});


$TeamIdCopyWith<$Res> get id;
...
as TeamId,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
...
$TeamIdCopyWith<$Res> get id {
  ...
  return $TeamIdCopyWith<$Res>(_self.id, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( TeamId id,  String name,  Color color)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Team() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( TeamId id,  String name,  Color color)  $default,) {final _that = this;
switch (_that) {
case _Team():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( TeamId id,  String name,  Color color)?  $default,) {final _that = this;
switch (_that) {
case _Team() when $default != null:
return $default(_that.id,_that.name,_that.color);case _:
  return null;
...
class _Team implements Team {
   _Team({required this.id, required this.name, required this.color});
  

@override final  TeamId id;
...
@override $TeamIdCopyWith<$Res> get id;
